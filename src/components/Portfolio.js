  ...
  const experiences = [
    {
      id: 1,
      company: "byTokn",
      role: "Founding Senior Full Stack Software Engineer Intern",
      ...
      highlights: [
        ...
        "Developed full-stack solutions with PostgreSQL database integration",
        "Collaborated with key stakeholders to understand business requirements and design tailored solutions",
        "Designed responsive UI layouts with React and Material UI, ensuring optimal user experience across all devices",
        "Implemented backend business logic and API services for seamless data integration between systems",
        "Created comprehensive unit test cases and implemented test automation for all delivered features",
        "Managed the complete product development lifecycle from initial concept to deployment",
      ],
    },
    {
      id: 2,
      ...
      highlights: [
        "Owned end-to-end product development for customer-facing applications using React, JavaScript, and backend services",
        "Built Single Page Applications with JavaScript frameworks and state management in Redux",
        "Collaborated with cross-functional teams including product managers, designers, and business stakeholders",
        "Mentored 4+ junior developers, providing technical guidance and code reviews to improve team capabilities",
        "Created comprehensive design documentation and unit test cases for all features developed",
      ],
    },
    {
      id: 3,
      ...
      highlights: [
        ...
        "Implemented test automation achieving 90%+ test coverage",
      ],
    },
    {
      id: 4,
